...
function Listing() {
	...
	return (
		<div className="page-container listing__grid">
				...
				<div className="listing__presentation__details">
					<div className="listing__presentation__details-location">
						{listing.location.village ? (
							...
							<p>
								<span>Located in</span> {listing.location.city},{" "}
								{listing.location.county}
							</p>
						)}
					</div>
			...
			<ul className="listing__amenities">
				<div className="listing__title">
					<p>Amenities</p>
					<div className="line" />
				</div>

				<div className="listing__amenities-list">
					{listing.amenities.length > 0 ? (
						listing.amenities.map((amenity, index) => (
							<li
								key={index}
								className="listing__amenities-list-btn"
							>
								{amenity}
							</li>
						))
					) : (
						<li>The host didn't specify any amenities</li>
					)}
				</div>
			</ul>
